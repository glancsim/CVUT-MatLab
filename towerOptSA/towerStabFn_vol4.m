function [value,volume,stressCond] = towerStabFn_vol4(sectionsID,crossSectionsSet)
...
beams.nelement  = nr;
suppT = transformationMatrixFn(beams);
beams.A = sections.A(beams.sections);
beams.I = min(sections.Iy(beams.sections),sections.Iz(beams.sections));
beams.E = sections.E(beams.sections);

beams.lengths = suppT.lengths';
