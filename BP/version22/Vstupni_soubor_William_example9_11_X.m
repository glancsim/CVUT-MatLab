...
% Prurez 1 v mmm
%========================================================================
A_prut(1)=20*0.0006451606243503233; %m2
Iy_prut(1)=6.67*4.1623142560e-7; %m4
Iz_prut(1)=166.67*4.1623142560e-7; %m4
Ip_prut(1)=26.67*4.1623142560e-7; %m4
%========================================================================
...
vektor_prutu=   [3.048 0 0 dp];
vektor_XY= [0 1 0]; 
[pp,nn]=size(vektor_prutu);   %pocet prutu
clear var nn

kc_stycniku=[0 0 0 0 0 0 ...
             1 2 3 4 5 6];
