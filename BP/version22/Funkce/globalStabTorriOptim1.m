clc
clear
ro=[61.4599 62.6488 57.5023 5.9437 3.8066];
% addpath('Funkce')
%========================================================================
%Průřezové parametry
%========================================================================
prurez=[1,2,3,4,5];%prurezove char. dle typu prutu: pozice=cislo prutu -> 1=A_prut(1)atd..
...
vektor_prutu=   [pointD-pointC, dp;...%Prut 1
                pointE-pointD, dp;...%Prut 2
                pointB-pointC, dp;...%Prut 3
                pointB-pointA, dp;...%Prut 4
                pointE-pointB, dp]; %Prut 5
