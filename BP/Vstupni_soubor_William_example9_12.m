...
% Prurez 1 v mmm
%========================================================================
A_prut(1)=22.4*0.0006451606243503233; %m2
Iy_prut(1)=82.5*4.1623142560e-7; %m4
Iz_prut(1)=2100*4.1623142560e-7; %m4
Ip_prut(1)=2.68*4.1623142560e-7; %m4
%========================================================================
...
%========================================================================
v=0.3;
E=29000*6894744.825494; %Pa

%========================================================================
%Parametry konstrukce
%========================================================================

dp=3; %deleni jednotlivych prutu 

vektor_prutu=   [0 7.3152 0 dp];
vektor_XY= [-1 0 0]; 
[pp,nn]=size(vektor_prutu);   %pocet prutu
clear var nn

kc_stycniku=[0 0 0 1 0 0 ...
             0 2 0 3 0 0];
...
f_global=zeros(pn,1);
f_global(2)=-1;
f_global(1)=-1*0.05*7.3152;
f_global(3)=+1*0.05*7.3152;
...
disp([num2str(prvni_vlastni_cislo*0.0002248089),' kips'])
