...
% Datum: 13-Jan-2026 22:45:09

%% PRŮŘEZY
sections.id = [10; 10];  % section id in sectionsSet.mat

%% UZLY
nodes.x = [0.0000; 0.0000; 10.0000];  % x coordinates of nodes
nodes.y = [0.0000; 10.0000; 10.0000];  % y coordinates of nodes
nodes.z = [0.0000; 10.0000; 0.0000];  % z coordinates of nodes
