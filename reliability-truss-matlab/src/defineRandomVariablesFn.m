...
InputOpts.Marginals(idx).Moments = [def.R1_mean, def.R1_mean * def.R1_cov];
...
InputOpts.Marginals(idx).Moments = [def.Q1_mean, def.Q1_mean * def.Q1_cov];
