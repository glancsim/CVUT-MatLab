...
%% PRŮŘEZ — Trubka, ocel
sections.A  = 28.5e-4;           % Plocha [m²]
sections.Iy = 1940e-8;         % Moment setrvačnosti k ose y [m⁴]
sections.Iz = 142e-8;         % Moment setrvačnosti k ose z [m⁴]
sections.Ix = 2082e-8;         % Polární moment (= Iy + Iz) [m⁴]
sections.E  = 210e9;      % [Pa]
sections.v  = 0.3;
