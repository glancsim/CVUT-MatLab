...
fprintf('\n');
fprintf('=== Scia Engineer - Example with 1 rotated beams ===\n\n');
fprintf('  Reference critical load 1    : F_ref = 73.63 kN\n');
fprintf('\n');
fprintf('  Critical load                : F_crit = %.2f kN\n', abs(lambda1));
fprintf('\n');
fprintf('  Reference critical load 2    : F_ref = 132.16 kN\n');
fprintf('\n');
fprintf('  Critical load                : F_crit = %.2f kN\n', abs(lambda2));