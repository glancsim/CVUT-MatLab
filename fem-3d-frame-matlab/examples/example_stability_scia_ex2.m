...
beams.angles    = [90; 0; 0; 0; 90; 0; 0; 0];
...
fprintf('\n');
fprintf('=== Scia Engineer - Example with 2 rotated beams ===\n\n');
fprintf('  Reference critical load 1    : F_ref = 53.34 kN\n');
fprintf('\n');
fprintf('  Critical load                : F_crit = %.2f kN\n', abs(lambda1));
fprintf('\n');
fprintf('  Reference critical load 2    : F_ref = 148.70 kN\n');
fprintf('\n');
fprintf('  Critical load                : F_crit = %.2f kN\n', abs(lambda2));